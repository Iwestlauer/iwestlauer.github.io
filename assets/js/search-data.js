...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Isabella Westlauer Resume last updated December 2025",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-welcome-to-my-new-webpage-sparkles-smile",
          title: 'Welcome to my new webpage! :sparkles: :smile:',
          description: "",
          section: "News",},{id: "projects-project-1-presentation",
          title: 'Project 1 Presentation',
          description: "a comparison of simple classification models",
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_dds_project1/";
            },},{id: "projects-my-first-r-shiny-page",
          title: 'My First R Shiny Page',
          description: "an exploratory data analysis of attrition data",
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_dds_rshinypage/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%69%77%65%73%74%6C%61%75%65%72@%73%6D%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Isabella_Westlauer_Resume_2025.pdf", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/isabella-westlauer", "_blank");
        },
      },{
        id: 'social-kaggle',
        title: 'Kaggle',
        section: 'Socials',
        handler: () => {
          window.open("https://www.kaggle.com/isabellawestlauer", "_blank");
        },
      },{
      id: 'light-theme',
